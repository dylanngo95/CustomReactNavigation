...
import SceneViewCustom from './SceneViewCustom';

/**
 * Component that renders the drawer.
 */
export default class DrawerViewCustom extends React.PureComponent {
  state = {
  ...
  _renderNavigationView = () => {
    ...
    <DrawerSidebarCusom 
      ...
      escriptors={this.props.descriptors} 
      contentComponent={this.props.navigationConfig.contentComponent} 
      contentOptions={this.props.navigationConfig.contentOptions} 
      drawerPosition={this.props.navigationConfig.drawerPosition} 
      style={this.props.navigationConfig.style} {...this.props.navigationConfig} 
    />;
  };
